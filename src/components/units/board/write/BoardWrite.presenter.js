...
export default function BoardWriteUI(props) {
  const {isEdit, isValidEdit, handleIsValidEdit, data, onSubmitCreate, onSubmitUpdate, onClickMoveToBack} = props;
      ...
      <S.WriteWrapper 
        ...
        <S.UserWrapper>
          ...
          <S.InputWrapper2>
            ...
            <S.Password type="password" autoComplete='off'
        ...
        <S.InputWrapper> 
          ...
          {errors.title?.type === "required" && (<S.Error>{errors.title.message}</S.Error>)}
        </S.InputWrapper>
        <S.InputWrapper>
          <S.Label htmlFor = "contents">내용</S.Label>
          <S.Content type = "textarea" 
                     placeholder='내용을 작성해주세요.'
                     defaultValue={data?.fetchBoard.contents}
          {...register("contents", {required : "내용이 입력되지 않았습니다"})}/>
          {errors.contents?.type === "required" && (<S.Error>{errors.contents.message}</S.Error>)}
        </S.InputWrapper>
        <S.InputWrapper>
          <S.Label>주소</S.Label>
          <S.ZipcodeWrapper>
        ...
        <S.InputWrapper>
          ...
          <S.UploadWrapper>
            <S.PicUpload><S.Plus>+</S.Plus>Upload</S.PicUpload>
            <S.PicUpload><S.Plus>+</S.Plus>Upload</S.PicUpload>
            <S.PicUpload><S.Plus>+</S.Plus>Upload</S.PicUpload>
          </S.UploadWrapper>
        </S.InputWrapper>
        <S.InputWrapper>
          ...
          <S.SettingWrapper>
            <S.RadioBtn type = "radio" id = "유튜브" name = "mainSetting" defaultChecked = "checked"/>
        ...
        <S.BtnWrapper>
          {isEdit && <S.CancealBtn type = "reset" onClick={onClickMoveToBack}>취소하기</S.CancealBtn>}
